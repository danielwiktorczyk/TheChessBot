...
public class BoardDriver {
	...
	public static void main(String[] args) {
		...
		System.out.println("Would you like an automatic game to be played? 1 for yes, 2 for no");
		int choice = keys.nextInt();
		keys.nextLine();
		int randomOcto = (int)((8*Math.random())+1);
		
		
		if ( choice == 1 ) {
			
			for ( int i = 0 ; (i < 21474836) && (mainBoard.getMoveNumber() != 1000) ; i++ ) {
